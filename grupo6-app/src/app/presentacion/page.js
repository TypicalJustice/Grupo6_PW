'use client';
import styles from './perfil2.css';
                    ...
                    <div className='formularioabajo'>
                        <Form>
                            <Form.Group className="mb-3abajo">
                                ...
                                <Form.Control required type="text" placeholder='Ingrese título' className='abajo' />
                            </Form.Group>
                        </Form>
                        <Form>
                            <Form.Group className="mb-3abajo">
                                <Form.Label>Presentación</Form.Label>
                                <Form.Control required type="text" placeholder='Ingrese descripción' className='abajo' />
                            </Form.Group>
                        </Form>
                    </div>
                </div>
